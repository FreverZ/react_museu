        ...
        <div className="login-container1">
          <div className="login-right-side">
            <div className="login-links-container">
              ...
              <span className="login-text1">Sobre Nós</span>
              <span className="login-text2">Contactos</span>
            </div>
          </div>
        </div>
        <div data-role="BurgerMenu" className="login-burger-menu">
          <svg viewBox="0 0 1024 1024" className="login-burger-menu1">
          ...
          <div className="login-nav">
            ...
            <div className="login-right-side1">
              <div className="login-links-container1">
                <span className="login-text3">Home</span>
                <span className="login-text4">About</span>
                <span className="login-text5">Tour Packages</span>
                <span>Contact</span>
              </div>
